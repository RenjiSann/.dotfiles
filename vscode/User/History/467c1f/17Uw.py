...
def merge_jsons(reference, clusters):
    ...
    for i, cluster in enumerate(clusters):
        ...
        ref_vec = np.array(ref["geometry"]["coordinates"], dtype="double")
        cluster_vec = np.array(cluster_image["geometry"]["coordinates"], dtype="double")
        ...
        for feature in cluster.features:
            new_pos = list(
                np.array(feature["geometry"]["coordinates"], dtype="double") - delta_vec
            )
            print(new_pos)
