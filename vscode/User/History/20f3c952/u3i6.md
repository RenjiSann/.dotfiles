...
integration in the [6.1 Linux kernel](https://kernelnewbies.org/Linux_6.1#Initial_support_for_the_Rust_programming_language) can emphasize), so it's not surprising it
