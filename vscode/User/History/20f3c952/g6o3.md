...
which provides the HAL bindings we will be using. This crate itself relies on
the [`stm32f4`](https://github.com/stm32-rs/stm32-rs) PAC crate which is
generated from the *.svd* files of the STM32 device.
