...
class EventSignupForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        labelize = lambda s: HTML(f"<label class=\"requiredField\">{s}<span class=\"asteriskField\">*</span></label>")

        self.helper.layout = Layout(
            Div(
                HTML("<label class=\"requiredField\">Informations de la participante</label>"),
                Row(
