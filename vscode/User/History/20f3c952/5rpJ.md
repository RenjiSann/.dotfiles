...
In the following example, the function call cannot tell us whether the string
was moved, copied or referenced, whereas Rust makes it explicit : `&` for
referencing, `.clone()` or similar to copy, and nothing to move.
