...
mod tests {
    ...
    mod elsif_clause {
        ...
        #[test]
        fn parse_rule_if_elsif_2() {
            let cmd = "if true ;then false ; elsif I am false; then goto bed ;fi";
            let res = parse_rule_if(cmd);
            if let Err(e) = &res {
                println!("{}", e.to_string());
            }
        ...
        #[test]
        fn parse_rule_if_elsif_several() {
        ...
        #[test]
        fn parse_rule_if_elsif_then_else() {
