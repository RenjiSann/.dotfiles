...
from gccsite.settings.common import AWS_S3_ENDPOINT_URL, AWS_S3_URL_PROTOCOL, AWS_S3_CUSTOM_DOMAIN
...
class Partner(models.Model):
    ...
    def logo_url(self):
        ...
        return f"{AWS_S3_URL_PROTOCOL}//{AWS_S3_CUSTOM_DOMAIN}/sponsors/{self.name}"
