...
{
    GObjectClass *object_class = G_OBJECT_CLASS (cudafilter);

  /* define virtual function pointers */
  object_class->set_property = gst_cuda_filter_set_property;
  object_class->get_property = gst_cuda_filter_get_property;

  /* define properties */
  g_object_class_install_property (object_class, PROP_TH_LOW,
    g_param_spec_int ("th_low", "Threshold low",
              "Threshold low",
              0, 255, 3, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
}
