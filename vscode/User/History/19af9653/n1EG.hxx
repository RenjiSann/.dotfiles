...
inline f32 lab_delta(rgb c1, rgb c2) {
    cie_lab l1 = xyz2lab(rgb2xyz(c1));
    cie_lab l2 = xyz2lab(rgb2xyz(c2));

    return std::sqrt(
        std::pow(l2.l - l1.l, 2.f) +
        std::pow(l2.a - l1.a, 2.f) +
        std::pow(l2.b - l1.b, 2.f)
    );
}
