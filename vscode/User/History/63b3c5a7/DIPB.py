...
def privacy_inscription_list():
    return [
        ...
        },
        {
            ...
            "content": """
            <p>Les données d’identification sont conservées en base active jusqu'à la désinscription de la personne.
            L'adresse email est sauvegardée 6 mois après la désinscription dans les sauvegardes.</p>
            """,
        },
        {
            "title": "Sécurité",
